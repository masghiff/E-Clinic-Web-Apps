...
<?php $__env->startSection('title', 'Form Tambah Obat'); ?>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                ...
                <form method="post" action="<?php echo e(route('obat.store')); ?>" class="form theme-form">
                    <?php echo csrf_field(); ?>
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\alexe\Documents\GitHub\SI-Klinik-KP\resources\views/pages/obat/add.blade.php ENDPATH**/ ?>