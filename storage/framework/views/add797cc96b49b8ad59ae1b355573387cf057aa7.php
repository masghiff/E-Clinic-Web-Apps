...
<?php $__env->startSection('title', 'Laporan Pasien Bulanan'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <div class="card p-4">
                    <form action="<?php echo e(route('pasien-bulanan')); ?>">
                        <div class="row">
                            <div class="col-9">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="display" id="basic-100">
                                ...
                                <?php $__currentLoopData = $TotalPasienBulanan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($i++); ?></td>
                                        <td><?php echo e($item->bulan); ?></td>
                                        <td><?php echo e(number_format($item->totalPasien,0,',','.')); ?> Orang</td>
                                    </tr>
...
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\alexe\Documents\GitHub\SI-Klinik-KP\resources\views/pages/laporan/Pasien/bulanan.blade.php ENDPATH**/ ?>