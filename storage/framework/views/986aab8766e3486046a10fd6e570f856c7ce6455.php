...
<?php $__env->startSection('title', 'Pendapatan Harian'); ?>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="display" id="basic-100">
                                ...
                                <?php $__currentLoopData = $pendapatanHarian; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td class="text-center"><?php echo e($item->tanggal); ?></td>
                                        <td class="text-center">Rp. <?php echo e(number_format($item->totalPendapatan,0,',','.')); ?></td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </tbody>
                            </table>
...
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\alexe\Documents\GitHub\SI-Klinik-KP\resources\views/pages/laporan/keuangan/pendapatan-harian.blade.php ENDPATH**/ ?>