...
<?php $__env->startSection('title', 'Pemeriksaan Pasien'); ?>
                ...
                <div class="card-body">
                    <div class="media static-top-widget">
                        <div class="media-body">
                            ...
                            <h4 class="mb-0 counter"><?php echo e($total_pasien_hari_ini); ?> Orang</h4>
                        </div>
                ...
                <div class="card-body">
                    <div class="media static-top-widget">
                        <div class="media-body">
                            ...
                            <h4 class="mb-0 counter"><?php echo e($total_pasien_7_hari); ?> Pasien</h4>
                        </div>
                ...
                <div class="card-body">
                    <div class="media static-top-widget">
                        <div class="media-body">
                            ...
                            <h4 class="mb-0 counter"><?php echo e($total_pasien_1_bulan); ?> Pasien</h4>
                        </div>
                ...
                <div class="card-body">
                    <div class="media static-top-widget">
                        <div class="media-body">
                            ...
                            <h4 class="mb-0 counter">Rp. <?php echo e(number_format($total_pemasukan->pemasukan)); ?></h4>
                        </div>
                        ...
                        <table class="display" id="basic-1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e($value->pasien); ?></td>
                                    <td><?php echo e($value->poli); ?></td>
                                    <td><?php echo e($value->dokter); ?></td>
                                    <td>
                                    ...
                                    <th>
                                        ...
                                        <?php elseif($value->status_bayar == 3): ?>
                                            <span class="badge badge-danger">Batal</span>
                                        <?php else: ?>
                                    ...
                                    <td>
                                        <?php if($value->status == "Menunggu Pemeriksaan"): ?>
                                            <?php if(Auth::user()->role == 'Dokter'): ?>
                                                <a href="<?php echo e(route('pemeriksaan.edit',$value->idkunjungan)); ?>" class="btn btn-warning text-dark"><?php echo e(Auth::user()->role == 'Dokter' ? 'Periksa Pasien' : 'Detail'); ?></a>
                                            <?php endif; ?>
                                            <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="<?php echo e(route('pembatalanPasien')); ?>" method="POST">
                                                <?php echo csrf_field(); ?>
                                                <input type="hidden" name="id" value="<?php echo e($value->idkunjungan); ?>">
                                        ...
                                        <?php elseif($value->status == "Menunggu Pembayaran"): ?>
                                            <?php if(Auth::user()->role != 'Dokter'): ?>
                                            <button class="btn btn-primary" type="button" onclick="pembayaranPasien(<?php echo e($value->idkunjungan); ?>)" data-bs-toggle="modal" data-original-title="test" data-bs-target="#example-modal" data-bs-original-title="" title="">
                                                Pembayaran
                                            </button>
                                            <?php endif; ?>
                                            <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="<?php echo e(route('pembatalanPasien')); ?>" method="POST">
...
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\alexe\Documents\GitHub\SI-Klinik-KP\resources\views/pages/pemeriksaan/index.blade.php ENDPATH**/ ?>